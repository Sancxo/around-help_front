    ...
    return (
        <form name="login" id="login-form" className="container">
            ...
            <fieldset>
                ...
                <input type="email" name="email" id="email-input" autoComplete="email" onChange={e => setEmail(e.target.value)} required />
                <br />

                <label htmlFor="password-input">Password:</label>
                <input type="password" name="password" id="password-input" autoComplete="current-password" onChange={e => setPassword(e.target.value)} required />
                <br />
